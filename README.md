...
**Business/Data Analytics Professional | 5+ Years of Experience | SQL • Tableau • Python • Strategy & Operations • Business Intelligence**
...
|---------|-------------|-------|
| [🍔 Food-Delivery-Marketplace-Business-Analysis](https://github.com/harshlibra97/Food-Delivery-Marketplace-Business-Analysis) | Business Case Study: AOV, Revenue, Profitability, Delivery Optimization & Customer Experience Analysis for a 3-Sided Food Delivery Marketplace | SQL, Python |
| [🏥 Healthcare-Patient-Analytics-Business-Case-Study](https://github.com/harshlibra97/Healthcare-Patient-Analytics-Business-Case-Study) | Business Case Study: Patient Analytics, Patient Journey, Product Analytics, Customer Experience & Healthcare Operations Analysis | SQL, Python |
| [🛒 E-Commerce Funnel & Conversion Analysis](https://github.com/harshlibra97/Ecommerce-Funnel-Conversion-Analysis-SQL-Python) | End-to-end funnel analysis measuring drop-off rates, conversion bottlenecks & revenue leakage | SQL, Python |
| [📊 Marketing Campaign Performance Analysis](https://github.com/harshlibra97/Marketing-Campaign-Performance-Analysis-Python) | Evaluating ROI, channel effectiveness & customer acquisition costs across campaigns | Python, Pandas |
| [🏪 Retail Sales Performance Analysis](https://github.com/harshlibra97/Retail-Sales-Performance-Analysis-SQL) | Uncovering revenue trends, top products & regional/seasonal performance patterns | SQL |
| [🚗 Uber Data Analysis](https://github.com/harshlibra97/Uber-Data-Analysis-by-Harshkumar-Patel) | Exploratory analysis of Uber ride data to uncover patterns and behavioral insights | Python, Jupyter |
| [🎤 TED Talks Analysis](https://github.com/harshlibra97/Ted-Talks-Analysis-by-Harshkumar-Patel) | Data-driven analysis of TED talk engagement metrics, viewership trends & speaker insights | Python, Jupyter |
...
[![Connect on LinkedIn](https://img.shields.io/badge/Connect%20on%20LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/harshkumarpatel97/)
